...
$stmt->execute(array(':title' => $title, ':uploaddate'=>$date, ':filename'=>$filename,':permission'=>'public',':owner'=>$userID,':type'=>'multivid',':caption'=>'none',':transcript'=>'none',':format'=>$format,':size'=>'med',':viewcount'=>0));
